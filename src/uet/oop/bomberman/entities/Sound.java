...
public class Sound {
    static Media media1 = new Media(new File("res/sound/AA126_11.wav").toURI().toString());
    static Media media2 = new Media(new File("res/sound/BOM_11_M.wav").toURI().toString());
    static Media media3 = new Media(new File("res/sound/BOM_SET.wav").toURI().toString());
    ...
    static Media media6 = new Media(new File("res/sound/CRYST_UP.wav").toURI().toString());
    static Media media7 = new Media(new File("res/sound/endgame3.wav").toURI().toString());//qua man
